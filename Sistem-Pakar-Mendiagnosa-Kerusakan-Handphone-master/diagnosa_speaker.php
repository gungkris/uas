...
$("div.btn-input").live('click', function(){
    ...
    btn.addClass('active btn-primary');
		...
		//tampilkan pertanyaan pertama
			$sqlp = "select * from diagnosa_speaker where mulai='Y'";
			$rs=mysql_query($sqlp);
		...
		//bentuk pertanyaan
			...
			echo "<CENTER><IMG SRC='hp.JPG' WIDTH='348' HEIGHT='257' BORDER=0 ALT=''></CENTER>";
		...
		//tampilkan pertanyaan pertama
			...
			$sqlp = "select * from diagnosa_speaker where id=$idsolusi";
